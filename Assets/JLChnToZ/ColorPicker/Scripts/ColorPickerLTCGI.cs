...
namespace JLChnToZ.VRC.ColorPicker
{
    ...
    public class ColorPickerLTCGI : UdonSharpBehaviour
    {
        ...
        void Update()
        {
            ...
            EmissionScreen.GetPropertyBlock(propertyBlock);
            propertyBlock.SetColor("_EmissionColor", selectedColor.gamma);
            indicatorOrb.SetPropertyBlock(propertyBlock);
            EmissionScreen.SetPropertyBlock(propertyBlock);
            ltcgi._SetColor(screenIndex, selectedColor);
        }
